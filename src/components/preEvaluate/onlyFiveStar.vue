    ...
    <scroll ref="scroll" :click="false" style="height: 100%">
      <div class="box">
        ...
        <div class="stepTwo">
          <h2>二、五星好评</h2>
          <p>
            1. 此订单为5星好评订单，只给商家5星好评，不用写字，严禁不勾选好评红花<br>
            2. 不得给商家低于5星好评，否则平台将会冻结账户，账户金额不予体现<br>
            3. 若淘宝/天猫快递未签收，就提前在平台或淘宝店铺确认好评，平台将扣除当次任务本金作为处罚
          </p>
        </div>
        <div class="sureBtn">
          <!--<router-link :to="{ name: 'submitSuccess',params: { type: 'evaluate1' } }">
            <button :disabled="!isOk" :class="{ook: !isOk}">我已确认</button>
          </router-link>-->
