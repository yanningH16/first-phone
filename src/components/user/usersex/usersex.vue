        ...
        <div class="settingsBox">
          <div class="sexBox">
            ...
            <div class="radioBox border-bottom-1px">
              <div class="radioBoxContainer" @click="chooseChecked=true">
                 <CheckBox :isChecked="chooseChecked"></CheckBox>
                 <span class="title">男</span>
              </div>
             <div class="radioBoxContainer border-bottom-1px" @click="chooseChecked=false">
                 <CheckBox :isChecked="!chooseChecked"></CheckBox>
