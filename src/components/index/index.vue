      ...
      <scroll ref="scroll" class="scroll-content" style="height:100%">
        <div class="index_cont">
          ...
          <div class="cont_show2">
            <h2 class="m_title">优质商品<span>白拿</span>到手软&nbsp;&gt;</h2>
            <div class="cont_show_scroll">
...
<style>
  ...
  .scrollContainer .cont_show2 .img, .scrollContainer .cont_show3 .img {
    width: 14.2rem;
    height: 14.2rem;
  }
  ...
  .scrollContainer .cont_show2 .wrap, .scrollContainer .cont_show2 .wrap {
    padding: 0;
  }

  .scrollContainer .cont_show2 .cont_show_scroll .scroll_item, .scrollContainer .cont_show3 .cont_show_scroll .scroll_item {
    width: 14.2rem;
