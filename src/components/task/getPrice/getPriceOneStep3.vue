    ...
    <scroll ref="scroll" class="scroll" :click="false">
      <div class="stepThree_box">
        ...
        <div class="warn">
          <p>
            注意：<br>
            1. 不得提起平台、白拿等关键字，否者封禁账号！<br>
            2. 聊天记录必须上传和指定商品店铺的聊天记录截图，不得上传虚假信息，否者封禁账号！<br>
            3. 商家客服超过5分钟未回复，可直接自助留言下单<br>
            4. 买家领取白拿商品一律不得向商家索要赠品和好评返现
          </p>
        </div>
        <div class="next">
          <!--<router-link :to="{ name: 'getPriceOneStep4' }">
    ...
    export default {
      ...
      methods: {
          doNext() {
            ...
            this.$router.push({name:'getPriceOneStep4',query: { buyerTaskRecordId: this.$route.query.buyerTaskRecordId, obj: obj }})
          }
      }
    }
</script>
