<template>
  <div class="common_box">
    ...
    <div class="good_intro border-bottom-1px">
      <img src="./img/TM.png" alt="goodImg">
      <div>
        <h2>{{goodsObj.goodsName}}</h2>
        <div><strong>规格</strong><span>{{goodsObj.temp}}</span></div>
        <div><strong>数量</strong><span>{{goodsObj.num}}</span></div>
        <div>
          <strong>价格</strong>
    ...
    <div class="good_num border-bottom-1px" v-if="goodsObj.orderNum">
      ...
      <div>
        <p><strong>{{goodsObj.info}}</strong></p>
        <p><strong class="err">{{goodsObj.errInfo}}</strong></p>
      </div>
    </div>
